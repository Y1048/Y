...
xml = """
<mujoco model="two_link_arm_stiff">
  <option timestep="0.001" gravity="0 0 -9.81" integrator="implicitfast"/>

  <default>
    <joint damping="6.0" armature="0.1"/>
    <geom density="250" rgba="0.35 0.55 0.9 1"/>
  </default>
  ...
  <actuator>
    <position name="shoulder_ctrl" joint="shoulder_pitch" kp="450" dampratio="1.2"/>
    <position name="elbow_ctrl" joint="elbow_pitch" kp="350" dampratio="1.2"/>
  </actuator>
</mujoco>
"""
...
with mujoco.viewer.launch_passive(model, data) as viewer:
    ...
    while viewer.is_running():
        ...
        data.ctrl[shoulder_ctrl] = math.radians(25.0) * math.sin(0.7 * t)
        data.ctrl[elbow_ctrl] = math.radians(-70.0 + 15.0 * math.sin(1.1 * t))
