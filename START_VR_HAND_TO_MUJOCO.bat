...
if "%UDP_RUNNING%"=="0" (
    echo [START] Mink/DAQP G1 right-arm controller
    start "G1 Mink Right Arm" /D "%CONTROLLER_ROOT%" cmd /k py -3.11 scripts\run_mink_g1_right_arm_prototype.py
) else (
...
echo.
echo Controller:
echo   Mink 6D FrameTask on right_wrist_yaw_link
