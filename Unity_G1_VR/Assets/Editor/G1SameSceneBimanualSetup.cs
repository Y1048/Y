...
public static class G1SameSceneBimanualSetup
{
    ...
    public static void Both() { Configure(); }
    ...
    private static void Configure()
    {
        ...
        if (leftHand == null || leftHand.GetComponent<OVRSkeleton>() == null)
        ...
        Debug.Log("Same scene: BOTH ARMS selected. Save scene, start START_G1_VR_TELEOP.bat, then Play.");
    }
}
