...
class PipelineTests(unittest.TestCase):
    ...
    def test_existing_runtime_gain_model_preservation(self):
        ...
        result=subprocess.run(['git','diff','--exit-code',
            ...
            ':!experiments/twist2_right_arm_manual/sysid_async_model.py',
            ':!experiments/twist2_right_arm_manual/test_sysid_async.py',
            ':!experiments/twist2_right_arm_manual/sysid_readonly_dds.cpp',
            ':!experiments/twist2_right_arm_manual/sysid_readonly_parse.py',
            ':!experiments/twist2_right_arm_manual/test_sysid_readonly.py',
            ':!experiments/twist2_right_arm_manual/sysid_quiet_stats.py',
            ':!experiments/twist2_right_arm_manual/test_sysid_quiet_stats.py',
            ':!experiments/twist2_right_arm_manual/native_vr_build/CMakeLists.txt',
            ...
            ':!experiments/twist2_right_arm_manual/sysid_native_observer.hpp',
            ':!experiments/twist2_right_arm_manual/test_sysid_native.py',
            ':!experiments/twist2_right_arm_manual/sysid_excitation_plan.py',
            ':!experiments/twist2_right_arm_manual/test_sysid_excitation_plan.py',
            ':!experiments/twist2_right_arm_manual/sysid_excitation_readiness.py',
            ':!experiments/twist2_right_arm_manual/test_sysid_excitation_readiness.py',
            ':!experiments/twist2_right_arm_manual/sysid_excitation_request.py',
            ':!experiments/twist2_right_arm_manual/test_sysid_excitation_request.py',
            ':!experiments/twist2_right_arm_manual/sysid_excitation_preview.py',
            ':!experiments/twist2_right_arm_manual/test_sysid_excitation_preview.py',
            ':!experiments/twist2_right_arm_manual/sysid_excitation_reference.hpp',
            ':!experiments/twist2_right_arm_manual/test_sysid_excitation_reference.cpp',
            ':!experiments/twist2_right_arm_manual/test_sysid_excitation_reference.py',
            ':!experiments/twist2_right_arm_manual/sysid_excitation_sequence.hpp',
            ':!experiments/twist2_right_arm_manual/test_sysid_excitation_sequence.cpp',
            ':!experiments/twist2_right_arm_manual/test_sysid_excitation_sequence.py',
            ':!experiments/twist2_right_arm_manual/sysid_excitation_plan_adapter.hpp',
            ':!experiments/twist2_right_arm_manual/sysid_excitation_plan_check.cpp',
            ':!experiments/twist2_right_arm_manual/test_sysid_excitation_plan_adapter.cpp',
            ':!experiments/twist2_right_arm_manual/test_sysid_excitation_plan_adapter.py',
            ':!experiments/twist2_right_arm_manual/sysid_excitation_plan_dump.cpp',
            ':!experiments/twist2_right_arm_manual/sysid_excitation_crosscheck.py',
            ':!experiments/twist2_right_arm_manual/test_sysid_excitation_crosscheck.py',
            ...
            ':!experiments/twist2_right_arm_manual/sysid_excitation_observer_bridge.hpp',
            ':!experiments/twist2_right_arm_manual/test_sysid_excitation_observer_bridge.cpp',
            ':!experiments/twist2_right_arm_manual/test_sysid_excitation_observer_bridge.py',
