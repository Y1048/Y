...
py -3.11 -B MuJoCo_G1_Controller\scripts\run_mink_g1_right_arm_virtual_center_live_entry.py --ik-solver vanilla --simulation-arm-cycle --upstream-mink-collision --speed-profile %mink_speed_profile%
