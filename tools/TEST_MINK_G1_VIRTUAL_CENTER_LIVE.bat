...
echo ============================================================
echo   G1 Mink LIVE VIRTUAL-CENTER Experiment
echo   - Internal position: right_wrist_roll_link
echo   - Internal rotation: right_wrist_yaw_link
echo   - External Unity/state frame: right_wrist_yaw_link
...
echo.
echo [RUN] Live virtual-center Mink controller
py -3.11 MuJoCo_G1_Controller\scripts\run_mink_g1_right_arm_virtual_center_live.py
if errorlevel 1 (
    echo.
    echo [ERROR] Virtual-center Mink controller exited with an error.
)
